...
7. [ ] **Medium**: Personal Reading List — browser-local bookmarking, scroll progress bar, read marking, export/import JSON (non-dnd/3)
...
**Overall: 30/32 features implemented (94%)**
