...
---
# /jobs-archive
Move completed jobs older than 14 days from MEMORY.md to an archive file.
...
5. If any jobs are older than 14 days:
...
6. If no jobs are older than 14 days, report: "No jobs ready for archival (all < 14 days old)."
