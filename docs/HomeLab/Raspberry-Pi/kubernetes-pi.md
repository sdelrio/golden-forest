...
* <https://www.raspberrypi.com/news/five-years-of-raspberry-pi-clusters/>
...
Live walkthrough with my brand new Raspberry Pi 4s, I show you how to install Kubernetes (k3s) to create a cluster and then how to deploy OpenFaaS.
