...
Attuning to a item requires a number of successful checks depending on item rarity, as indicated the table below. The DC of this check is 15.  
The number of successes must be consecutive, and the check is made using an Arcana check or your Spellcasting ability + Prof bonus (your choice).  
