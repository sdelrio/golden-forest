...
+ While you are wearing heavy armor and wielding a shield, when an attack that deals bludgeoning, piercing, slashing or force damage, would deal less damage than your Base AC from a single instance, you instead take no damage from that attack.
