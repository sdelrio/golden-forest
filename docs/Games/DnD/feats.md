...
+ While you are wearing heavy armor and wielding a shield, when you take bludgeoning, piercing, slashing or force damage equal to or less than (Armor bonus to AC + Shield bonus to AC + Special Bonus to AC) from a single instance, you instead take no damage.
