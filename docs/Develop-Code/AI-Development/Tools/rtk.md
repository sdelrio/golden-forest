...
- [OpenCode CLI](../Skills-and-Agents/Agents/opencode.md) — Terminal-first AI agent with native RTK support.
- [Claude Code](../Skills-and-Agents/Agents/claude-code.md) — Anthropic's agentic CLI tool.
