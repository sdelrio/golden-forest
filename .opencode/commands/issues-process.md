...
2. Fetch the issue with comments and labels: `gh issue view $ARGUMENTS --comments`.
...
7. Commit using Conventional Commits (reference the issue as `<number>.` — never `#<number>` outside the closing keyword).
